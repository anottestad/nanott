...
class WPCustomerReviews {
    ...
    function get_options() {
        ...
        $default_options = array(
            ...
            'field_custom' => array(),
            'form_location' => 0,
            'goto_leave_text' => 'Current client? Click here to submit a review!',
            'goto_show_button' => 1,
    ...
    function output_reviews_show($inside_div, $postid, $perpage, $max, $hide_custom = 0, $hide_response = 0, $snippet_length = 0, $show_morelink = '') {
        ...
        if (count($reviews) == 0) {
            ...
            foreach ($reviews as $review) {
                ...
                if ($this->options['hreview_type'] == 'product') {
                    $reviews_content .= '
                        <div class="hreview blaahh" id="hreview-' . $review->id . '">
                    ...
                    $reviews_content .= '
                        <div class="hreview grid_6" id="hreview-' . $review->id . '">
                            <div class="wpcr_clear wpcr_spacing1"></div>
                            ...
                            <div class="description"><p>' . $review->review_text . '</p></div>
                            ' . $review_response . '
